...
test_example() {
    ...
    echo "Example $exampleN: ./main $execArgs"
    ./main $execArgs 1> ./results/ex$exampleN-your_stdout.txt 2> ./results/ex$exampleN-your_stderr.txt
...
gcc -std=c11 -Wall -Wextra -Werror main.c -o main > ./results/compilation_out.txt 2>&1
ret=$?
if [ $ret -ne 0 ]; then
...
echo "$BLUDISTE" > ./inputs/bludiste.txt
echo "$BLUDISTE_INVALID" > ./inputs/bludiste_invalid.txt
echo "$REF_STDOUT_EX1" > ./results/ex1-ref_stdout.txt
echo "$REF_STDOUT_EX2" > ./results/ex2-ref_stdout.txt
echo "$REF_STDOUT_EX3" > ./results/ex3-ref_stdout.txt
echo "$REF_STDOUT_EX4" > ./results/ex4-ref_stdout.txt
echo "$REF_STDOUT_EX5" > ./results/ex5-ref_stdout.txt
echo "$REF_STDOUT_EX6" > ./results/ex6-ref_stdout.txt
